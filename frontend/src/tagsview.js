        ...
        <div className="tags-post-content">
          {mimeType.includes("image") ? (
            <img
              ...
              draggable={false}
              alt={url}
              className="tags-post-image"
            />
          ) : mimeType.includes("video") ? (
            <video
              src={url}
              draggable={false}
              className="tags-post-video"
              controls
            ></video>
          ) : null}
        </div>
          ...
          <div className="tag-view-header-left-side">
            {isImage ? (
              <img
                ...
                alt=""
                draggable={false}
                className="tag-view-header-image"
              />
            ) : null}
            {!isImage ? (
              <video
                src={HOST_URL + "/" + imageurl}
                draggable={false}
                className="tag-view-header-video"
              ></video>
            ) : null}
          </div>
          <div className="tag-view-header-right-side">
            <span style={{ fontSize: "24px" }}>{"#" + tag}</span>
