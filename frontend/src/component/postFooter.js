  ...
  useEffect(() => {
    if (isMounted)
      axios
        .get(
          HOST_URL +
            "/get_comment_countAndCheck_user_like?postId=" +
            post[0].postId,
          {
            headers: {
    ...
    <>
      ...
      <div className="footer-post-buttons">
        <div className="footer-post-left-side">
          <Notifications style={style.fav} onClick={handleLike} />
          <CommentButton style={style.comment} onClick={handleComment} />
        </div>
        <div className="footer-post-right-side">
          <Bookmark style={style.bookmark} onClick={handleSave} />
        </div>
      </div>
      <div className="footer-post-description">
        {calledFrom === "postviewer" ? (
          <></>
        ) : (
          <div
        ...
        <div>
          {calledFrom === "postviewer" ? (
            ...
            <a href={postUrl} style={style.linkStyle1}>
              {commentCount > 1
        ...
        <a href={postUrl} style={style.linkStyle}>
          {customdate}
        </a>
      </div>
      <hr />
